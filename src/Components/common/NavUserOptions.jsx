...
import {MdExitToApp, MdPerson, MdInfoOutline, MdBugReport} from 'react-icons/md';
...
export default function NavUserOptions({setShowOptions}) {
    ...
    return (
        <div className={`${styles.user_options_bottom_drawer} displayFlex flexCol`}>
            ...
            <Link to="/bugreport" onClick={() => setShowOptions(false)} className={`${styles.user_options} displayFlex itemsCenter p2 `}>
                <MdBugReport className="mr1" /> Bug Report
            </Link>
